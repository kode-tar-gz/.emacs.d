...
***DISCLAIMER***: A lot of the custom helper functions in kode-mode.el are made with the help of generative AI. I'm no Elisp wizard (yet) sadly, but I still had things I wanted to get done without spending hours learning hidden emacs functions.
